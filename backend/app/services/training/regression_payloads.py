...
"""Backend helpers for regression Results payloads.

These functions translate business-layer regression diagnostics into
...
def build_regression_decoder_outputs_payload(
    *,
    ...
    """Build a DecoderOutputs-like payload for regression.
