...
def _to_rows_and_header(
    ...
    NOTE: The tabularization helper for prediction results (`utils/predicting/prediction_results.py`)
    produces a Sequence[Mapping], which is directly supported here.
    """
