...
"""Decoder outputs payload assembly.

Segment 6 canonicalization: there is only one way to build decoder outputs.
This module provides a small wrapper used by training use-cases.
"""
...
def build_decoder_outputs_payload(
    *,
    ...
    """Assemble the decoder outputs contract.
