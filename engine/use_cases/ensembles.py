...
from engine.reporting.common.json_safety import safe_float_list, safe_float_scalar, dedupe_preserve_order
...
# ---------------- Bagging report ----------------
    ...
    # Persist model artifact (best-effort)
    store_resolved = resolve_store(store)
    try:
        save_model_to_store(store_resolved, effective_model, result["artifact"])
    except Exception:
        pass
