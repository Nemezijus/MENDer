import { Box, Stack, Divider, Text, Group } from '@mantine/core';
...
export default function RandomSearchConfigPane({
  // Split
  nSplits,
  onNSplitsChange,
  stratified,
        ...
        <Group gap="md" align="flex-end">
          <Box className="tuningNarrowInput">
            <NumberOverrideInput
              ...
              min={1}
              step={1}
              valueOverride={nIterOverride}
              defaultValue={defaultNIter}
