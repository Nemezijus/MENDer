...
export default function BgmmSection({ m, set, sub, enums, d }) {  return (
    <ParamGrid>
        <ParamNumber
        ...
        <ParamSelect
          ...
          placeholder={defaultPlaceholder(d?.covariance_type)}
        ...
        <ParamSelect
          ...
          placeholder={defaultPlaceholder(d?.init_params)}
        ...
        <ParamSelect
          ...
          placeholder={defaultPlaceholder(d?.weight_concentration_prior_type)}
          onChange={(v) => set({ weight_concentration_prior_type: overrideOrUndef(v, d?.weight_concentration_prior_type) })}
        />
        <ParamCheckbox
          label="Warm start"
