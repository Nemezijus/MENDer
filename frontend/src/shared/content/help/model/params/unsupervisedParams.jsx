...
export const UNSUPERVISED_PARAM_BLOCKS = {
  kmeans: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> K-Means parameters </Text>{" "}
  ...
  dbscan: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> DBSCAN parameters </Text>{" "}
      <List className="helpOptionList">
        {" "}
        <List.Item>
          {" "}
  ...
  spectral: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> Spectral clustering parameters </Text>{" "}
      <List className="helpOptionList">
        {" "}
        <List.Item>
          {" "}
    ...
    <Stack className="helpParamSection">
      ...
      <List className="helpOptionList">
        ...
        <List.Item>
          ...
          (linkage) – how clusters are merged (ward, complete, average,
          single).{" "}
        </List.Item>{" "}
        <List.Item>
          {" "}
  ...
  gmm: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> Gaussian Mixture parameters </Text>{" "}
      <List className="helpOptionList">
        {" "}
        <List.Item>
          {" "}
        ...
        <List.Item>
          ...
          (covariance_type) – shape of covariance (full, diag, tied,
          spherical).{" "}
        </List.Item>{" "}
        <List.Item>
          {" "}
  ...
  meanshift: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> MeanShift parameters </Text>{" "}
      <List className="helpOptionList">
        {" "}
        <List.Item>
          {" "}
  ...
  birch: (
    <Stack className="helpParamSection">
      {" "}
      <Text className="helpTitle"> Birch parameters </Text>{" "}
      <List className="helpOptionList">
        {" "}
        <List.Item>
          {" "}
